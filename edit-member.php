    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" name="surname" value="<?php echo $row['Sur_name']; ?>" id="surname" autocapitalize="on">
                            </div>
                            <div class="form-group mb-3">
                                <label for="other_names">Other names</label>
                                <input type="text" class="form-control" name="othername" value="<?php echo $row['Other_name']; ?>" id="other_names" autocapitalize="on">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group mb-3">
                                <label for="sex">Sex</label>
                                <input type="text" class="form-control" name="sex" value="<?php echo $row['Sex']; ?>" id="sex">
                            </div>
                            <div class="form-group mb-3">
                                <label for="b_date">Birth Date</label>
                                <input type="date" class="form-control" name="birthdate" value="<?php echo $row['Birth_Date']; ?>" id="b_date">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group mb-3">
                                <label for="b_place">Birth Place</label>
                                <input type="text" class="form-control" name="birthplace" value="<?php echo $row['Birth_Place']; ?>" id="b_place">
                            </div>
                            <div class="form-group mb-3">
                                <label for="b_region">Birth Region</label>
                                <input type="text" class="form-control" name="region" value="<?php echo $row['Birth_Region']; ?>" id="b_region">
                            </div>
                            <div class="form-group mb-3">
                                <label for="b_district">Birth District</label>
                                <input type="text" class="form-control" name="district" value="<?php echo $row['Birth_District']; ?>" id="b_district">
                            </div>
                        </div>
                    </div>
            ...
            <div class="card-footer">
                <a href="view-members.php" class="btn btn-outline-danger">Cancel</a>
            </div>
        </div>
    </div>
